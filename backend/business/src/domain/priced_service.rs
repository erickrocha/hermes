...
use entity::priced_service_entity::{ActiveModel, Model};
...
pub struct PricedServiceEntityMapper {}

impl EntityMapper<PricedService, Model, ActiveModel> for PricedServiceEntityMapper {
    fn build_active_model(d: PricedService) -> ActiveModel {
        ActiveModel {
            id: match d.id {
                Some(id) => Set(id),
                None => NotSet,
            ...
            default_value_cents: Set(d.default_value_cents),
    ...
    fn from_model(e: Model) -> PricedService {
        PricedService {
            id: Some(e.id),
            ...
            name: e.name,
            category: e.category,
            default_value_cents: e.default_value_cents,
    ...
    fn from_active_model(mut e: ActiveModel) -> PricedService {
        ...
        match model {
            ...
            Err(_) => PricedService {
                ...
                default_value_cents: e.default_value_cents.take().flatten(),
